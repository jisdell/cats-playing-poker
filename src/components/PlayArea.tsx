...
export const PlayArea = () => {
  ...
  const seatContainerVertical = 'flex items-center justify-center flex-col gap-4'
  ...
  return (
    ...
    >
      {/* top */}
      <div className={`${seatContainerBase} col-span-1 row-start-1 col-start-2 p-4`}>
        {genSeats(0)}
      </div>
      {/* right */}
      ...
      {/* bottom */}
      <div className={`${seatContainerBase} col-span-1 row-start-3 col-start-2 p-4`}>
        {genSeats(2)}
      </div>
      {/* left */}
